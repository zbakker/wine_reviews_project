...
## Price  
* The distribution of price is right skewed as the median price is $25 and mean price is $35.36, with a handful of prices that are far above average. The maximum price in the origindal dataset is $3300. The minimum price is $4. Outliers from $200 to $3300 have been removed to prevent skewing the final model.  
...
## Points  
* Points are awarded by Wine Enthusiast on a scale of 0-100. This dataset only contains wines with point assignments of 80 and up. The table below gives explanations of the points.  
